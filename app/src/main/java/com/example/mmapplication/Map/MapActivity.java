package com.example.mmapplication.Map;
...
public class MapActivity extends AppCompatActivity
    ...
    LinearLayout hospitals,parks,stores;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hospitals = (LinearLayout)findViewById(R.id.hos);
        parks = (LinearLayout)findViewById(R.id.parks);
        stores = (LinearLayout)findViewById(R.id.departments);
        ...
        stores.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showPlaceInformation(currentPosition,PlaceType.DEPARTMENT_STORE);
            }
        });
 ...
 // 3. 위치 업데이트 시작
    ...
    public void onPlacesSuccess(final List<Place> places) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Log.e("hhhh",Integer.toString(places.size()));
                //중복 마커 제거
    ...
    public void showPlaceInformation(LatLng location,String plase)
    {
        mMap.clear();//지도 클리어
        ...
        new NRPlaces.Builder()
                ...
                .key("AIzaSyDLQ6F-gPGe-kTC6jBwdfc5xJdX4BGE_2Y")
